import { Button, Input, Slider, Snackbar, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, } from "@mui/material";
...
export const ListPage = () => {
    ...
    return (
        <>
            <Snackbar open={showNativeNotification} onClose={() => setShowNativeNotification(false)} message='"Native" field has already existed' autoHideDuration={1000}></Snackbar>
            <Snackbar open={showTranslationNotification} onClose={() => setShowTranslationNotification(false)} message='"Translation" field has already existed' autoHideDuration={1000}></Snackbar>
            ...
            <TableContainer>
                <Table>
                    ...
                    <TableBody>
                        <TableRow>
                            <TableCell>
                                <Input value={native} onChange={e => setNative(e.target.value)} placeholder="Native..."></Input>
                            </TableCell>
                            <TableCell>
                                <Input value={translation} onChange={e => setTranslation(e.target.value)} placeholder="Translation..."></Input>
                            </TableCell>
                            <TableCell></TableCell>
                            <TableCell>
...
const WordItem: FC<{ word: Word }> = ({ word }) => {
    ...
    const updateProgress = useCallback(() => db.words.update(word.id || 0, { progress: newProgress }), [newProgress, word.id])
